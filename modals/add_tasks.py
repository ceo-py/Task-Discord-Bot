...
class AddTaskModal(discord.ui.Modal, title="Add task to database"):
    task_name = discord.ui.TextInput(label='Task name from Judge',
                                     placeholder="Replace space and extra characters with _",
                                     max_length=40)
    task_urls = discord.ui.TextInput(label='Task URL', placeholder="Paste the URL link on the task solution",
                                     max_length=500)
